...
public class LearnedSongServiceImpl implements LearnedSongService {
    ...
    // 최근 학습한 곡 목록 조회 - 2
//    @Override
//    public RecentLearnedSongsVersion2Response getRecentLearnedSongsVersion2(Long userId, int page, int size) {
//        // 1. 사용자 존재 여부 확인
//        if(!memberAuthRepository.existsByIdAndDeletedFalse(userId)){
//            throw new MemberNotFoundException("존재하지 않는 회원입니다.");
//        }
...
//        // 2. 사용자의 학습 기록이 있는지 확인
//        if (!learnedSongRepository.existsByUserId(userId)) {
//            RecentLearnedSongsVersion2Response.PaginationResponse pagination = new RecentLearnedSongsVersion2Response.PaginationResponse(
//                    page,
//                    size,
//                    0L, // totalItems = 0
//                    0,  // totalPages = 0
...
//            );
//
//            return new RecentLearnedSongsVersion2Response(
//                    Collections.emptyList(), // 빈 배열
//                    pagination
//            );
//        }
...
//
//        // 6. LearnedSongResponse 변환
//        List<LearnedSongVersion2Response> learnedSongs = learnedSongPage.getContent().stream()
//                .<LearnedSongVersion2Response>map(learnedSong -> {
//                    Song song = songMap.get(learnedSong.getSongId());
//                    return this.convertToLearnedSongVersion2Response(learnedSong, song);
//                })
//                .collect(Collectors.toList());
//
//        // 7. PaginationResponse 생성
...
//        );
//
//        return RecentLearnedSongsVersion2Response.builder()
//                .learnedSongs(learnedSongs)
//                .pagination(pagination)
//                .build();
//    }
//
//    private LearnedSongVersion2Response convertToLearnedSongVersion2Response(LearnedSongEntity learnedSong, Song song) {
//        return LearnedSongVersion2Response.builder()
//                .learnedSongId(learnedSong.getLearnedSongId())
//                .userId(learnedSong.getUserId())
//                .songId(learnedSong.getSongId())
