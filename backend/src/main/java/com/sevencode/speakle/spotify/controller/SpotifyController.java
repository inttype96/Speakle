...
public class SpotifyController {
	...
	public void connect(HttpServletResponse response,
		@Parameter(hidden = true) UserPrincipal auth) throws IOException {
		String redirect = spotifyService.buildAuthorizeRedirect(auth);
	...
	public ResponseEntity<String> callback(
		...
		response.sendRedirect("/settings/integrations?spotify=connected");
	...
	public ResponseEntity<Void> disconnect(@Parameter(hidden = true) UserPrincipal auth) {
	...
	@GetMapping("/status")
	public ResponseEntity<SpotifyLinkStatusResponse> getStatus(@Parameter(hidden = true) UserPrincipal auth) {
	...
	@GetMapping("/player")
	public ResponseEntity<Object> getCurrentPlayback(@Parameter(hidden = true) UserPrincipal auth) {
	...
	@GetMapping("/profile")
	public ResponseEntity<Object> getUserProfile(@Parameter(hidden = true) UserPrincipal auth) {
		return ResponseEntity.ok(spotifyService.getUserProfile(auth));
	}

	@Operation(summary="플레이리스트 목록", description="사용자 플레이리스트 목록 조회")
	@GetMapping("/playlists")
	public ResponseEntity<Object> getUserPlaylists(UserPrincipal auth) {
	...
	public ResponseEntity<Void> pausePlayback(UserPrincipal auth) {
	...
	public ResponseEntity<Void> resumePlayback(UserPrincipal auth) {
	...
	public ResponseEntity<Void> skipToNext(UserPrincipal auth) {
	...
	public ResponseEntity<Void> skipToPrevious(UserPrincipal auth) {
