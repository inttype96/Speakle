              ...
              <div className="w-full max-w-[400px]">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <Input
                    ...
                    required
                    className="w-full h-12 rounded !bg-[#ffffff] placeholder:text-slate-700 px-4 text-[14px] focus:outline-none border-0 text-slate-900 font-['Pretendard'] shadow-none"
                  />
                  <Input
                    type="password"
